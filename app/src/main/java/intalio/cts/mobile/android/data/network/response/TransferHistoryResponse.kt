...
data class TransferHistoryResponse(
	...
	val data: ArrayList<TransferHistoryDataItem>? = null,
...
data class ReceivingEntityIdItem(
...
data class TransferHistoryDataItem(

	@field:SerializedName("receivingEntityId")
	val receivingEntityId: List<ReceivingEntityIdItem?>? = null,
