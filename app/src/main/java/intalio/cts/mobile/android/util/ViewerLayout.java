...
/**
 * Created by aem on 11/21/2017.
 */

public class ViewerLayout extends RelativeLayout implements ScaleGestureDetector.OnScaleGestureListener {
    ...
    public ViewerLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public ViewerLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void applyScaleAndTranslation() {
        ...
        child().setPivotX(1f);  // default is to pivot at view center
        child().setPivotY(1f);  // default is to pivot at view center
