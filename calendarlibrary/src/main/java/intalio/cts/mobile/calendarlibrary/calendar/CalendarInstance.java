package intalio.cts.mobile.calendarlibrary.calendar;
...
import intalio.cts.mobile.calendarlibrary.R;
...
//            if (language == MyCalendarView.Language.Arabic.getLanguageValue()) {}

            if (MyCalendarView.language == MyCalendarView.Language.Arabic.getLanguageValue()) {
                monthNames = new String[]{
                        context.getResources().getString(R.string.muharram_ar),
                        context.getResources().getString(R.string.safar_ar),
                        context.getResources().getString(R.string.rabi_i_ar),
                        context.getResources().getString(R.string.rabi_ii_ar),
                        context.getResources().getString(R.string.jamada_i_ar),
                        context.getResources().getString(R.string.jamada_ii_ar),
                        context.getResources().getString(R.string.rajab_ar),
                        context.getResources().getString(R.string.shaban_ar),
                        context.getResources().getString(R.string.ramadan_ar),
                        context.getResources().getString(R.string.shawal_ar),
                        context.getResources().getString(R.string.dhu_alqadah_ar),
                        context.getResources().getString(R.string.dhu_alhijjah_ar)};
            }else {
