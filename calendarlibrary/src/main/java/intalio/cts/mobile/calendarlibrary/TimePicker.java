...
import static intalio.cts.mobile.calendarlibrary.MyCalendarView.Language.Arabic;
...
import intalio.cts.mobile.calendarlibrary.calendar.MyCustomCalendar;
    ...
    public static final Formatter TWO_DIGIT_FORMATTER_HOUR =
            new Formatter() {
                ...
                public String format(int value) {
                    if (intalio.cts.mobile.calendarlibrary.MyCalendarView.language == Arabic.getLanguageValue()) {
